...
class BaseEncoder(nn.Module):
    ...
    # * add interfeats
    def extract_features(self, x: Tensor,x_1 = None, x_2 =None, x_3 = None, *args, **kwargs) -> Tensor:
        x = self.conv_1(x)
        x = self.layer_1(x)
        x = self.layer_2(x)
        x = self.layer_3(x)
        ...
        return x
    # * add interfeats
    def extract_features_with_inter_feat(self, x: Tensor,x_1 = None, x_2 =None, x_3 = None, *args, **kwargs) -> Tensor:
        x = self.conv_1(x)
        x = self.layer_1(x)
        x1 = x
        ...
        if x_3 == None:
            ...
            x = self.conv_1x1_exp(x_3)
        
        return x, x1, x2, x3
    
    def forward(self, x: Tensor, return_feature=False , x1 = None, x2 = None, x3 = None, *args, **kwargs) -> Tensor:
        if return_feature:
            x, x1, x2, x3 = self.extract_features_with_inter_feat(x)
            x = self.classifier(x)
            return x, x1, x2, x3
        elif x1 != None:
            x, _, _ ,_ = self.extract_features_with_inter_feat(x, x_1=x1)
            x = self.classifier(x)
           
            return x
        elif x2 != None:
            x, _, _ ,_ = self.extract_features_with_inter_feat(x, x_2=x2)
            x = self.classifier(x)
           
            return x
        elif x3 != None:
            x, _, _ ,_ = self.extract_features_with_inter_feat(x, x_3=x3)
            x = self.classifier(x)
            return x
