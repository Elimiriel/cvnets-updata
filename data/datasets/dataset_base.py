...
class BaseDataset(data.Dataset, ABC):
    ...
    def get_item_metadata(self, item_idx: int) -> Dict:
        ...
        Args:
            item_idx (int): The index of sample to provide metadata for. The indexing
...
class BaseVideoDataset(BaseDataset, ABC):
    ...
    def get_item_metadata(self, item_idx: int) -> VideoMetadataDict:
        ...
        Args:
            item_idx (int): The index of video file to provide metadata. The indexing
                should be aligned with how ``self.__getitem__(item_idx)`` sequences the
                dataset items.
...
class VideoMetadataDict(TypedDict, total=False):
    ...
    video_duration: float  # video_fps * total_video_frames  (Required for VideoClipBatchSampler)
    audio_fps: float
